...
export default function HeroSection() {
  ...
  return (
    <div className="bg-white relative w-full max-w-full">
        ...
        >
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">CodeWarriors</span>
              <img
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 w-full max-h-full max-w-full order-1">
        <div
        ...
        <div className="mx-auto w-full max-w-full py-32 sm:py-48 lg:py-56">
